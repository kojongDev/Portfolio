...
- 강원대학교
  - 컴퓨터 정보통신공학과 졸업 (2012.03 ~ 2019.06)
...
- CIPS (2018.06 ~ 2018.07) : 자동차 보험 갱신 일정과 사고 내역으로 향후 4년간의 보험료의 인상 및 인하를 확인할 수 있는 App
  ...
  - 결과물
  - Android: [App Link](https://play.google.com/store/apps/details?id=com.toprms)

---

- Eggray (2018.08 ~ 2018.10) : 아기띠에 로드셀을 부착하여 아이의 무게를 실시간으로 측정하고, 육아에 대한 정보를 제공하는 App
...
- CreaCube (2018.11 ~ 2019.02) : 장난감 '구구단 큐브'와 연동하는 App으로 학습 분석 및 다양한 컨텐츠 제공
  ...
  - 결과물
    - Android: [App Link](https://play.google.com/store/apps/details?id=com.gugudancube)
    - IOS: [App Link](https://apps.apple.com/kr/app/creacube-english/id1489602710)
...
- 10콜3방 (2019.06 ~ 2019.08) : 영업 사원의 목표 성과를 설정하고 관리해주는 App
  ...
  - 결과물
    - Android: [App Link](https://play.google.com/store/apps/details?id=com.customermanagement)
...
- 나도사장님 (2019.09 ~ 2019.12) : 프렌차이즈 홍보를 위한 어플리케이션
  ...
  - 결과물
    - Android: [App Link](https://play.google.com/store/apps/details?id=com.eolab.imceo)
    - IOS: [App Link](https://apps.apple.com/kr/app/%EB%82%98%EB%8F%84%EC%82%AC%EC%9E%A5%EB%8B%98/id1115518445)
...
- 니르바나 (2019.11 ~ 2019.12) : 귀 안마개 제어 App
  ...
  - 결과물
    - Android: [App Link](https://play.google.com/store/apps/details?id=com.nirvana)
...
- 버핏서울 웹 리뉴얼 및 유지보수 (2020.04 ~ )
  - Bootstrap, Vue, Django 를 이용하여 서비스 개선을 통해 사용자들에게 편안한 UI 를 만들고자 리뉴얼을 진행
  - 서비스 운영 초기와 달리 새로운 기능들이 계속해서 늘어나면서 프로그램의 효율성이 떨어지기 시작했고, Django 와 React 를 이용한 리뉴얼 작업 진행
  - React + Next 를 이용하여 SEO 관리를 할 수 있도록 개발을 진행하고, 새로운 상태관리 라이브러리 Recoil 사용
  - 결과물
    - Web: [버핏서울 홈페이지](https://www.butfitseoul.com)

---

- 버핏서울 앱 개발 및 유지보수 (2020.09 ~ 2021.11)
  - React-Native, TypeScript, Recoil, Axios를 기본으로 작업 진행
  - 사용자가 버핏서울의 서비스를 제대로 사용할 수 있도록 도와주는 어플리케이션 입니다.
  - 트레이너의 수업관리 및 회원 관리를 통해 향상된 서비스를 제공하였고, 회원의 수업관리 및 채팅 기능을 통하여 버핏서울이 제공하는 서비스를 완벽하게 느낄 수 있도록 하였다.
  - 결과물
    - Android: [App Link](https://play.google.com/store/apps/details?id=com.butfit.seoul)
    - IOS: [App Link](https://apps.apple.com/kr/app/%EB%B2%84%ED%95%8F%EC%84%9C%EC%9A%B8-%ED%9A%8C%EC%9B%90%EC%9A%A9-%ED%97%AC%EC%8A%A4%EB%B3%B4%EB%8B%A4-%ED%99%95%EC%8B%A4%ED%95%9C-%EA%B7%B8%EB%A3%B9%EC%9A%B4%EB%8F%99/id1500532697)

---

- 스노아 앱 개발 및 유지보수 (2021.06 ~ )
  - React-Native, TypeScript, Recoil 기본으로 작업 진행
  - 워터 로잉머신 '스노아'의 어플리케이션으로, 계기판을 통해 현재 운동 상황을 파악 할 수 있으며 자신의 운동 기록을 확인 할 수 있는 기능을 제공
  - 워터 로잉머신에 탑재된 블루투스 모듈과 통신하여 현재 로잉머신의 운동 상태를 모바일로 전달
  - 결과물
    - Android: [App Link](https://play.google.com/store/apps/details?id=com.butfitseoul.snoar)
    - IOS: [App Link](https://apps.apple.com/ci/app/%EC%8A%A4%EB%85%B8%EC%95%84-%EC%8A%A4%EB%A7%88%ED%8A%B8%ED%95%9C-%ED%99%88%ED%8A%B8%EC%9D%98-%EC%8B%9C%EC%9E%91/id1582994096)

---

- 버핏 리스트 웹 & 하이브리드 앱 (2021.01 ~ 2021.01)
  - Bootstrap, Django, React-Native, Typescript 사용
  - 운동 크리에이터의 영상을 모아 사용자가 원하는 운동 스타일의 크리에이터를 추천해주고, 해당 크리에이터의 운동 영상을 모아 운동 스케줄을 관리하고, 리워드를 제공하여 운동에 대한 욕구를 느낄 수 있도록 해주는 웹 서비스입니다.
  - 다양한 사용자들의 만족을 위해 해당 웹을 하이브리드 어플리케이션으로 만들어 제공
  - 결과물
    - Web: [버핏리스트 홈페이지](https://butfitlist.com/)
    - Android: [App Link](https://play.google.com/store/apps/details?id=com.threeweeks.threeweeks)
    - IOS: [App Link](https://apps.apple.com/kr/app/%EB%B2%84%ED%95%8F%EB%A6%AC%EC%8A%A4%ED%8A%B8-best-%ED%99%88%ED%8A%B8-%EC%98%81%EC%83%81-%ED%94%8C%EB%A0%88%EC%9D%B4%EB%A6%AC%EC%8A%A4%ED%8A%B8/id1551180007)
